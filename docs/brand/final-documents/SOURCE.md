...
Basiscommit: e9c95c4269de830bfeea229aa657d512166d5520. Implementierungscommit: b6d5686c768dde71c7bd8df1b1bdcdb63b0a0749.
...
`````json
{
  ...
  "files": {
    ...
    "packages/eh-design/src/html-style.mjs": "afe460f77e8864deec7a014031d0d681107402d69a3ba6fa81e7a94e6356d006",
    "packages/eh-design/src/html.css": "512f7075efc5cc4c62a168130dfcf79a54863000a251174416b41798d9bb0109",
    "packages/eh-design/src/html.mjs": "7dde2a71e7eccbe9ddd7888bfb7b8d96a0a91c74e6fd07a2501070abf72d6033",
    "packages/eh-design/src/index.ts": "089ccde5aff27c2aa22db13d8567b10d89de69788c3d34bedc4970648f380ca8",
    ...
    "packages/eh-design/src/styles.module.css": "5380afcb60d5f91ce4f6a194ce93716a39c4e68421b9e79ebc39aec06ed11eea",
...
## design/workspace-preview/documents/evidence.json
...
## docs/brand/workspace/FINAL-DOCUMENTS.md
...
## packages/eh-design/src/documents.tsx
...
## src/app/app/documents/[jobId]/receipt/page.tsx
...
export default async function Receipt({params}:{params:Promise<{jobId:string}>}){
 ...
 return <EHDocumentFrame><main className="receipt-page"><article className="receipt"><EHLogo href="/app"/><div className="receipt-title"><div><h1>Zahlungsbeleg</h1><p>Einfach Hausen Plattform</p></div><b>#{String(p.id).padStart(6,'0')}</b></div><div className="receipt-grid"><div><small>Kunde</small><strong>{p.first_name} {p.last_name}</strong></div><div><small>Dienstleister</small><strong>{p.business_name}</strong></div><div><small>Auftrag</small><strong>{p.title}</strong></div><div><small>Zahlungsdatum</small><strong>{new Date(p.paid_at).toLocaleDateString('de-DE')}</strong></div></div><div className="receipt-line"><span>Vereinbarter Auftragsbetrag</span><strong>{euroExact(p.amount)}</strong></div><div className="receipt-total"><span>Bezahlt</span><strong>{euroExact(p.amount)}</strong></div><p className="receipt-note">Dieser Beleg bestätigt die über die Plattform erfasste Zahlung. Eine steuerliche Rechnung über die Handwerkerleistung stellt der beauftragte Dienstleister aus.</p><div className="print-hide"><PrintButton /></div><p className="print-hint print-hide">Zum Speichern oder Drucken dieses Belegs die Druckfunktion des Browsers verwenden.</p></article></main></EHDocumentFrame>;
}

`````

## src/app/app/home/passport/page.tsx
...
## src/app/pro/invoices/[id]/page.tsx
