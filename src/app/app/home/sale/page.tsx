...
import { EHButton, EHCheckbox, EHEmptyState, EHField, EHFormSection, EHSelect, EHStepProgress, EHTextarea, EHInput, EHStatus, EHSubmitButton, EHRecordList, EHRecordViews, EHText, EHWorkflowForm, EHWorkflowStack, type EHRecordEntry } from '@/design-system';
...
export default async function Sale() {
  ...
  return <WerkbankRahmen role="homeowner" active="/app/home/sale" brandSub={property.address}>
    <EHWorkflowStack>
    <WerkbankKopf title="Verkauf & Bewertung" context={property.address || property.postcode || undefined} />

    <WerkbankKennzahlen label="Verkauf & Bewertung" items={[
    ...
    <WerkbankRaster main={<>
    <WerkbankAbschnitt title="Immobilienbewertung">
    ...
    <WerkbankAbschnitt title="Ich möchte verkaufen">
    {!lead ? <EHEmptyState title="Passende Makler für dein Haus finden" text="Noch werden keine Kontaktdaten weitergegeben." action={<EHWorkflowForm action={startSaleProcessAction}><EHSubmitButton pendingLabel="Maklerabgleich läuft …">Makler finden</EHSubmitButton></EHWorkflowForm>} /> : <>
      ...
      <WerkbankAbschnitt title="Verkaufsstand">
        {lead ? <>
      ...
      <WerkbankAbschnitt title="Letzte Bewertung">
        {lastValuation ? <>
      ...
      <WerkbankAbschnitt title="Freigegebene Makler">
      ...
      <WerkbankAbschnitt title="Fragen zum Verkauf">
