...
import {
  ...
  CitationList,
  CitationStack,
} from "@/components/ui/streaming-response-utils/citations";
import { AgentDisclosure } from "@/components/ui/streaming-response-utils/agent-disclosure";
import {
  EASE_OUT,
  SPRING_PRESS,
  SPRING_SWAP,
} from "@/components/ui/streaming-response-utils/ease";
import { cn } from "cn";
...
function ResponseAction({
  ...
  return (
    <motion.button
      ...
      title={label}
      aria-pressed={
        label === "Helpful" || label === "Not helpful" ? isOn : undefined
      }
      onClick={onClick}
...
export function StreamingResponse({
  ...
  const setFeedbackState = (next: Exclude<StreamingResponseFeedback, null>) => {
