...
- **App-Frontend (Operator-Order 2026-09-25):** v0 übernimmt nach der Website auch Owner-App und Betriebs-App in derselben Qualität. Freiheit: Komposition, Bausteine, additive Tokens, Beispiel-Motive. Unverrückbar: Auth/Daten/Backend (T-0168, keine Mocks), freigegebene Kompositionen (Dashboard/Aufträge/Kontakthierarchie/Kopf-Menüleiste/Hausakte-Referenz), Telefon-Regeln, Werkbank-Richtung, ARIA-statt-Klassen, versiegelter Kern + Debt-Baseline, E2E-Anker, Ehrlichkeits-Regeln. Vollständige Beauftragung: `docs/agent-handoffs/v0-app-frontend-briefing-20260925.md`. Abnahme: Gates + Jeremy (Pflicht) → Deploy durch Subagent.
