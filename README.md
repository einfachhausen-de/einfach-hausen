...
Stand 2026-09-22: Die KI-/OCR-Welle bis 77942d4 ist auf OCI produktiv verifiziert. Laya läuft resident und authentifiziert; Dokumente nutzen digitalen PDF-Text direkt, sonst Tesseract-OCR, inklusive HEIC-Normalisierung. Echte PDF-, PNG- und iPhone-HEIC-Smokes liefen Queue → OCR/Text → Laya → Klassifikation/Frist fehlerfrei. 35/35 Node-KI-Tests, 3/3 Laya-Service-Tests, Release-Gate 17/17 und öffentlicher Smoke 18/18 sind grün. Jev-/DeepSeek-Betreiberkeys sind weiterhin nicht konfiguriert; der lokale Standardpfad bleibt davon unabhängig.
